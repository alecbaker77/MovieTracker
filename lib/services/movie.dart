...
import 'package:movie_tracker_app/model/movie_preview.dart';
import 'package:movie_tracker_app/secret/themoviedb_api.dart' as secret;
import 'package:movie_tracker_app/utils/constants.dart';
import 'package:movie_tracker_app/utils/file_manager.dart';
...
class MovieModel {
  ...
  Future<List<MovieCard>> getMovies({
    ...
    //var myFavorites = DatabaseMethods().getFavorites(Constants.userId);
